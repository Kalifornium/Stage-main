  ...
  <body>
    ...
    <div style="height: 750px; display:flex;">
      <div style="margin: auto; text-align: left;">
        ...
        <div style="display: flex; flex-direction: row;" class="hover09">
          <figure class="real"><img src="Images/image1.jpg" class="real"></figure>
          <figure class="real"><img src="Images/image2.jpg" class="real"></figure>
          <figure class="real"><img src="Images/image3.jpg" class="real"></figure>
          <figure class="real"><img src="Images/image4.jpg" class="real"></figure>
        </div>
        <div style="display: flex; flex-direction: row;" class="hover09">
          <figure class="real"><img src="Images/image5.jpg" class="real"></figure>
          <figure class="real"><img src="Images/image6.jpg" class="real"></figure>
          <figure class="real"><img src="Images/image7.jpg" class="real"></figure>
          <figure class="real"><img src="Images/image8.jpg" class="real"></figure>
        </div>
      </div>
    </div>
